---
title: "cssS-LB_DSM-epi_analysis_walkthrough"
author: "Kenyon"
...
gcfile<-read.csv("C:/Users/Kenyon/Documents/Bacillus_subtilis/Growth Rates/Eon data/DSM-LB-2rowseach+cssS/LB-gcfit-repsavgd2016-02-01.csv")
gcfile<-gcfile[,-1]
...
feature      description
----------   ----------------------------------------------------
Lag          All KOs have longer lag than AM373 (~10%); CN has longest lag (similar to in Triton-X)
Growth rate  All appear very similar; none significantly different (similar to in Triton-X)
A            CssS - higher than all other strains (2%), MN - significantly smaller than all other strains (4%) (similar to in Triton-X)
