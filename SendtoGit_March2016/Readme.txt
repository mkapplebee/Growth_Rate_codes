...
CssS_XXX folders contain the .Rmd and .html files that perform the "gc" and "epi" analysis on the described dataset (CssS strain set in the described growth condition)  
  ...
  - The code is demonstrated, but the html output files do not display the images generated by the .Rmd on my desktop, even though the static files open fine elsewhere
